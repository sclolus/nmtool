...
/*   Updated: 2018/08/17 05:41:00 by sclolus          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int32_t	ofile_load_narch(t_ofile *ofile, uint32_t narch)
{
	...
	ofile->narch = narch;
	if (ofile->fat_archs)
		load_macho_ofile(ofile,  (void *)((uint8_t *)ofile->vm_addr + ofile->fat_archs[narch].offset));
	else
		load_macho_ofile(ofile,  (void *)((uint8_t *)ofile->vm_addr + ofile->fat_archs_64[narch].offset));
	return (0);
}
